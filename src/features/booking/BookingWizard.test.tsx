...
describe('BookingWizard', () => {
  ...
  it('creates a booking from API data', async () => {
    ...
    expect(screen.queryByText('1 บริการ')).not.toBeInTheDocument()
    expect(screen.queryByText('2 วันเวลา')).not.toBeInTheDocument()
    expect(screen.queryByText('3 ข้อมูลติดต่อ')).not.toBeInTheDocument()
    expect(screen.getByRole('heading', { name: 'บริการ' })).toBeInTheDocument()
    expect(screen.getByRole('heading', { name: 'วันเวลา' })).toBeInTheDocument()
    expect(screen.getByRole('heading', { name: 'ข้อมูลติดต่อ' })).toBeInTheDocument()
